...
async function submitForm() {
    ...
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbwcnRVbYnul7Q8bdAnihuIByvvlb3mNq4IkttBqc0cRM0NeKyMngA4NixdWt9EcjZee/exec', { // Replace with your Google Apps Script URL
            method: 'POST',
            headers: {
